    ...
    extend: {
      colors: {
        ...
        sidebar: {
          ...
          primary2: "hsl(var(--sidebar-primary-2))",
          "primary-foreground-2": "hsl(var(--sidebar-primary-foreground-2))",
        ...
        "syntax-tag": "hsl(var(--syntax-tag))",
        "syntax-attribute": "hsl(var(--syntax-attribute))",
